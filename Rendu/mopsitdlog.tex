...
Pour qualifier la vraisemblance d'un suffixe et d'un radical nous n'utilisons plus l'information mutuelle pondÃ©rÃ© mais les estimateurs suivants : 
...
Si on obtient deux maximum menant Ã  une segmentation alors on garde celle-ci. \\
Si toutes les segmentations sont diffÃ©rentes alors on prends celle donnée par le maximum d'information provenant des radicaux. 
